...
function MyDearest() {
    return (
      ...
      font-semibold  text-white text-center rounded">
            <a href="https://snap-engineering-round-git-7b8720-christians-projects-c4c8dbeb.vercel.app/"> myDearest</a>
        </button>
    )
}
      ...
      <div className="relative...">
          ...
          <div className="flex items-center flex-col py-2 ">
             <p className= "bg-transparent py-30 px-80"> </p>
              ...
              < MyButton /> <p className= "bg-transparent py-6"> </p> <Linkdin/>  <MyDearest/>
          </div>
      </div>
  );
}
